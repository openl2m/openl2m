...
.. note::
    ...
    At the time of writing (Oct 2025), the Arista eAPI driver is READ-ONLY!
...
* **Arista eAPI**: for Arista switches supported via the eAPI REST API. Also set the proper Credentials Profile!
...
.. note::
    ...
    At the time of writing, the eAPI driver is READ-ONLY!
