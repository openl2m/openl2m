...
- **HPE Comware REST API driver** (faster then snmp for single devices)
- **HPE Aruba AOS-S REST API driver** (faster then snmp for single devices)

802.1Q interface vlan tag editing is now supported for the following drivers/devices:
...
- HPE Comware via SNMP
- HPE Aruba AOS-S via SNMP
