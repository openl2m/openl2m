...
In views.py, (see also urls.py) this is handled in the class *class InterfaceDescriptionChange()*.
...
In the *Connector()* object, we implement the placeholder bookkeeping function *Connector().set_interface_description()*
