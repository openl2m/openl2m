...
CONNECTOR_TYPE_EAPI = 3  # Arista devices via the eAPI
CONNECTOR_TYPE_HPE_CW7_NC = 4  # HPE Comware 7 NetConf devices
CONNECTOR_TYPE_HPE_CW_REST = 5  # HPE Comware 7 REST API devices
CONNECTOR_TYPE_AOS_S_REST = 6  # Aruba AOS-S switches REST API
...
CONNECTOR_TYPE_CHOICES = [
    ...
    [CONNECTOR_TYPE_AOS_S_REST, "Aruba AOS-S REST"],
    [CONNECTOR_TYPE_EAPI, "Arista eAPI"],
    [CONNECTOR_TYPE_COMMANDS_ONLY, "Commands Only"],
    #    [CONNECTOR_TYPE_HPE_CW7_NC, "HPE CW7 NetConf"],
    [CONNECTOR_TYPE_HPE_CW_REST, "HPE Comware REST"],
...
# https://github.com/carlkidcrypto/ezsnmp/blob/main/ezsnmp/interface.cpp

SNMP_V3_AUTH_NONE = 0
SNMP_V3_AUTH_MD5 = 1
SNMP_V3_AUTH_SHA = 2  # SHA-1
SNMP_V3_AUTH_SHA224 = 3
SNMP_V3_AUTH_SHA256 = 4
SNMP_V3_AUTH_SHA384 = 5
...
SNMP_V3_PRIV_DES = 1
# SNMP_V3_PRIV_3DES = 2
SNMP_V3_PRIV_AES = 3  # AES-128
SNMP_V3_PRIV_AES192 = 4
SNMP_V3_PRIV_AES256 = 5
SNMP_V3_PRIV_AES192C = 6  # Cisco specific AES-192
...
LOG_VIEW_DOWNLOAD_INTERFACES = 12
LOG_VIEW_TOP_ACTIVITY = 13
LOG_VIEW_SETTINGS = 14
LOG_LOGIN = 90
LOG_LOGOUT = 91
...
LOG_CHANGE_INTERFACE_VLANS = 127

# REST driver log entries
LOG_DEVICE_REST_OPEN = 161
LOG_DEVICE_REST_CLOSE = 162
LOG_DEVICE_REST_GET = 163
LOG_DEVICE_REST_POST = 164
LOG_DEVICE_REST_PUT = 165
LOG_DEVICE_REST_DELETE = 165
...
# Health related - generic entry
LOG_HEALTH_MESSAGE = 400
...
# 6xx - REST ADMIN API actions:
LOG_REST_API_ADMIN_USER_GET_ALL = 601
LOG_REST_API_ADMIN_USER_CREATE = 602
LOG_REST_API_ADMIN_USER_GET = 603
LOG_REST_API_ADMIN_USER_MODIFY = 604

LOG_REST_API_ADMIN_SWITCH_GET_ALL = 606
LOG_REST_API_ADMIN_SWITCH_CREATE = 607
LOG_REST_API_ADMIN_SWITCH_GET = 608
LOG_REST_API_ADMIN_SWITCH_MODIFY = 609

LOG_REST_API_ADMIN_SWITCHGROUP_GET_ALL = 611
LOG_REST_API_ADMIN_SWITCHGROUP_CREATE = 612
LOG_REST_API_ADMIN_SWITCHGROUP_GET = 613
LOG_REST_API_ADMIN_SWITCHGROUP_MODIFY = 614

LOG_REST_API_ADMIN_SNMP_PROFILE_GET_ALL = 616
LOG_REST_API_ADMIN_SNMP_PROFILE_CREATE = 617
LOG_REST_API_ADMIN_SNMP_PROFILE_GET = 618
LOG_REST_API_ADMIN_SNMP_PROFILE_MODIFY = 619

LOG_REST_API_ADMIN_NETMIKO_PROFILE_GET_ALL = 621
LOG_REST_API_ADMIN_NETMIKO_PROFILE_CREATE = 622
LOG_REST_API_ADMIN_NETMIKO_PROFILE_GET = 623
LOG_REST_API_ADMIN_NETMIKO_PROFILE_MODIFY = 624
...
LOG_ACTION_CHOICES = [
    ...
    [LOG_VIEW_SETTINGS, "View Settings"],
    [LOG_LOGIN, "Login"],
    [LOG_LOGOUT, "Logout"],
    ...
    # REST driver log entries
    [LOG_DEVICE_REST_OPEN, "Device REST Open"],
    [LOG_DEVICE_REST_CLOSE, "Device REST Close"],
    [LOG_DEVICE_REST_GET, "Device REST Get"],
    [LOG_DEVICE_REST_POST, "Device REST Post"],
    [LOG_DEVICE_REST_PUT, "Device REST Put"],
    [LOG_DEVICE_REST_DELETE, "Device REST Delete"],
