...
class Connector():
    ...
    def get_switch_basic_info(self):
        ...
        """
        self.error.clear()
        dprint("Connector.get_switch_basic_info()")
    ...
    def set_interface_admin_status(self, interface, new_state):
        ...
        interface.admin_status = int(new_state)
        self.save_cache()
        return True
    ...
    def set_interface_poe_available(self, interface, power_available):
        ...
        interface = Interface() object for the requested port
        available_power = in milli-watts (eg 4.5W = 4500)
    ...
    def set_interface_untagged_vlan(self, interface, new_pvid):
        ...
        interface.untagged_vlan = new_pvid
        self.save_cache()
        return True
    ...
    def run_command(self, command_id, interface_name=''):
        ...
        cmd['id'] = command_id
        # now go do it:
        nm = NetmikoConnector(self.switch)
