...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='read_only',
            field=models.BooleanField(
                default=False, help_text='The checked, this switch will be read-only.', verbose_name='Read-Only access'
            ),
        ),
        migrations.AlterField(
            model_name='switch',
            ...
            field=models.PositiveIntegerField(
                default=0, help_text='SNMP Bulks read count performed on the switch.', verbose_name='SNMP Bulk Reads'
            ),
        ),
        migrations.AlterField(
            model_name='switch',
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                default=0, help_text='SNMP read count performed on the switch.', verbose_name='SNMP Reads'
            ),
        ),
        migrations.AlterField(
            model_name='switch',
            ...
            field=models.PositiveIntegerField(
                default=0, help_text='SNMP write count performed on the switch.', verbose_name='SNMP Writes'
            ),
        ),
        migrations.AlterField(
            model_name='switchgroup',
            ...
            field=models.BooleanField(
                default=False,
                help_text='If set, the switches in this group are read-only for all users, except Admins',
